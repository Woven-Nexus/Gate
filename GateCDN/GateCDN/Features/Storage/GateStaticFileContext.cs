...
internal struct StaticFileContext {
	...
	public StaticFileContext(HttpContext context, GateStaticFileOptions options, ILogger logger, IFileProvider fileProvider, string? contentType, PathString subPath) {
	...
	public readonly string PhysicalPath => _fileInfo.PhysicalPath ?? string.Empty;
	...
	public Task ApplyResponseHeadersAsync(int statusCode) {
		...
		if (_options.OnPrepareResponse != GateStaticFileOptions._defaultOnPrepareResponse || _options.OnPrepareResponseAsync != GateStaticFileOptions._defaultOnPrepareResponseAsync) {
