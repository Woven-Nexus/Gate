...
/// </summary>
public class GateStaticFileOptions : SharedOptionsBase {
	...
	/// </summary>
	public GateStaticFileOptions() : this(new SharedOptions()) {
	}
	...
	public GateStaticFileOptions(SharedOptions sharedOptions) : base(sharedOptions) {
